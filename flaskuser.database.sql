...
CREATE USER flaskuser IDENTIFIED BY "flaskuser";
GRANT CONNECT, RESOURCE TO flaskuser;
GRANT UNLIMITED TABLESPACE TO flaskuser;
...
(
    ...
    CONSTRAINT FK_GEOMETRIES_ID FOREIGN KEY ("A_GEOMETRIES_ID")
...
/*"Longitudinal spring rate (N/mm)" VARCHAR(50),*/
    ...
    CONSTRAINT FK_TEST_ID FOREIGN KEY ("B_TESTS_ID")
