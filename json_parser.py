...
def save_all_json(json_file_name):
    try:
        ...
        if not col_length_validation('A_GEOMETRIES', A_Geometries_cols) or not col_length_validation('B_TESTS',
                ...
                'C_LOADING_CONDITIONS', C_Loading_conditions_cols):
            ...
            return 'JSON File is corrupted. File has been deleted from server'
        ...
        e_dict, e_link_back_dict=oracle_db.read_all_rows_and_save('E_COMPONENTS', E_Components_results_cols, E_Components_results_rows)
